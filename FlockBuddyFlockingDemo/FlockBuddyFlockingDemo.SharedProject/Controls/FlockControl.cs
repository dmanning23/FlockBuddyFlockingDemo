...
namespace FlockBuddyFlockingDemo
{
	public class FlockControl : StackLayout
	{
		...
		public FlockControl(FlockManager flock, FlocksCollection flocks, FlocksScreen flocksScreen) : base(StackAlignment.Top)
		{
			Flock = flock;
			_flocks = flocks;
			...
			button.AddItem(new Label(Flock.DebugColor.ToString(), FontSize.Small)
			{
